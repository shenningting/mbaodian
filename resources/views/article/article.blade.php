...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/3dd38c5eb19043548362b1f191b56a92.css')}}" type="text/css" />
</head>
<body >
                    ...
                    <div class="item-btm clearfix">
                        ...
                        <div class="r right-info">
                            <div class="favorite l" id="zan" value="<?php echo $v['a_id']?>">
                                <img src="{{asset('images/zan.jpg')}}"  class="zan" width="15" height="20">
                        ...
                        <li>
                            ...
                            <div class="arti-info clearfix">
                                <ul>
                                    <li class="hd-pic">
                                        <a class="publisher-hd" href="#" target="_blank">
                                            <img src="{{asset('picture/545861d500015cc602200220-100-100.jpg')}}" alt="" width="20" height="20" />
                                        </a>
                    ...
                    <ol class="weekly-top">
                        <li>
                            <a href="#" class="l hot-head" target="_blank" title="">
                                <img src="{{asset('picture/554ce69d0001044101000100-100-100.jpg')}}" alt="" width="40" height="40" />
                            </a>
                        ...
                        <li>
                            <a href="#" class="l hot-head" target="_blank" title="">
                                <img src="{{asset('picture/5572a2ef00017bfa01000100-100-100.jpg')}}" alt="" width="40" height="40" />
                            </a>
                            <a href="#" target="_blank" class="hot-name">
                                哈哈哈_3</a>
                        ...
                        <li>
                            <a href="#" class="l hot-head" target="_blank" title="">
                                <img src="{{asset('picture/5333a0d9000196ff02000200-100-100.jpg')}}" alt="" width="40" height="40" />
                            </a>
                            <a href="#" target="_blank" class="hot-name">
                                果果爱吃苹果</a>
                        ...
                        <li>
                            <a href="#" class="l hot-head" target="_blank" title="">
                                <img src="{{asset('picture/56b0c3df0001fbd501000100-100-100.jpg')}}" alt="" width="40" height="40" />
                            </a>
                            <a href="#" target="_blank" class="hot-name">
                                汪洋拾贝</a>
                        ...
                        <li>
                            <a href="#" class="l hot-head" target="_blank" title="">
                                <img src="{{asset('picture/56dc2ac40001583301000100-100-100.jpg')}}" alt="" width="40" height="40" />
                            </a>
                            <a href="#" target="_blank" class="hot-name">
                                围城之java</a>
                        ...
                        <li>
                            <a href="#" class="l hot-head" target="_blank" title="">
                                <img src="{{asset('picture/56eff52a0001d07401000100-100-100.jpg')}}" alt="" width="40" height="40" />
                            </a>
                            <a href="#" target="_blank" class="hot-name">
                                缄默蜀黍ONE</a>
