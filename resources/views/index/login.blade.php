...
<link rel="stylesheet" href="{{asset('css/common-less.css')}}" type="text/css">
...
-->
<link rel="stylesheet" href="{{asset('css/common-less_002.css')}}" type="text/css">
<link rel="stylesheet" href="{{asset('css/profile-less.css')}}" type="text/css">

<script src="{{asset('js/jquery.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/seajs-text.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/common.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/string.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/suggest.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/store.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/json.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/im.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/setprofile.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/socket.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/placeholder.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/validate.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/messagebox.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/settingUitl.js')}}" async="" charset="utf-8"></script><script src="{{asset('js/layer.js')}}" async="" charset="utf-8"></script><link href="{{asset('js/layer.css')}}" rel="stylesheet" charset="utf-8"></head>
<body>
        ...
        <!--         <li><a href="/wiki"  target="_self">WIKI</a></li> -->
            ...
            <ul class="clearfix logined">
                ...
                <li class="set_btn user-card-box">
                    <a id="header-avator" class="user-card-item" action-type="my_menu" href="http://www.imooc.com/u/3116765/courses" target="_self"><img src="{{asset('picture/56f9e5ab0001e7b101000100-40-40.jpg')}}" height="40" width="40">
                    ...
                    <div class="g-user-card">
                        <div class="card-inner">
                            <div class="card-top">
                                <a href="http://www.imooc.com/u/3116765/courses"><img src="{{asset('picture/56f9e5ab0001e7b101000100-100-100.jpg')}}" alt="qq_本宫未死休想纳妾_03116765" class="l"></a>
...
</script><script src="user_files/h.txt" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=f0cfcccd7b1393990c78efdeebff3968" target="_blank"><img src="{{asset('picture/21.gif')}}" height="20" width="20" border="0"></a>
<script>
(function(){
